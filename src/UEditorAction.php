...
class UEditorAction extends Action
{
    ...
    public function init()
    {
        ...
        //load config file
        $this->config = ArrayHelper::merge($_config['upload'], $this->config);
        parent::init();
    }
    ...
    protected function actionUpload()
    {
        ...
        /* 生成上传实例对象并完成上传 */
        $up = new Uploader($fieldName, ArrayHelper::merge($config,['disk' => ArrayHelper::getValue($this->config,'disk','local')]), $base64);
